      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-4 text-sm leading-7 font-mono">
          <p className="text-muted-foreground">
            ...
            Ingeniero de Sistemas con +5 meses de experiencia diseñando
          </p>
          <p className="text-muted-foreground">
            <span className="text-line-number mr-4 select-none">02</span>
            Arquitecturas Fullstack robustas y soluciones de infraestructura.
          </p>
          <p className="text-muted-foreground">
          ...
          <p className="text-muted-foreground">
            <span className="text-line-number mr-4 select-none">04</span>
             Optimización de rendimiento a nivel de sistema.
          </p>
        ...
        <div className="mt-12 grid grid-cols-3 gap-4">
          {[
            { label: "Meses exp.", value: "5+", color: "text-primary" },
